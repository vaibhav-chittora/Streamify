        ...
        <nav className="bg-black border-gray-200">
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                <Link to="/" className="flex items-center space-x-3 rtl:space-x-reverse">
                    ...
                    <span className="self-center text-2xl font-semibold whitespace-nowrap text-white">Streamify</span>
                </Link>
                ...
                <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-search">
                    <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-black md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-black">
                        <li>
                            <Link
                                to="/"
                                className={`block py-2 px-3 rounded md:bg-transparent md:p-0 ${location.pathname === '/' ? 'text-blue-500' : 'text-white'}`}
                        ...
                        <li>
                            <Link
                                to="/trending"
                                className={`block py-2 px-3 rounded md:bg-transparent md:p-0 ${location.pathname === '/trending' ? 'text-blue-500' : 'text-white'}`}
                        ...
                        <li>
                            <Link
                                to="/web-series"
                                className={`block py-2 px-3 rounded md:bg-transparent md:p-0 ${location.pathname === '/web-series' ? 'text-blue-500' : 'text-white'}`}
                                aria-current={location.pathname === '/web-series' ? 'page' : undefined}
                            >
                                Web-Series
                            </Link>
                        </li>
